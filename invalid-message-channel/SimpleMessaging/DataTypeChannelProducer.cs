...
namespace SimpleMessaging
{
    public class BadDataTypeChannelProducer<TActual, TIntended> : IDisposable where TActual: IAmAMessage where TIntended: IAmAMessage
    {
        ...
        public BadDataTypeChannelProducer(Func<TActual, string> messageSerializer, string hostName = "localhost")
        {
            ...
            _channel.QueueDeclare(queueName, exclusive: false, autoDelete: false, durable: false);
            ...
            _channel.QueueBind(queue: queueName, exchange: ExchangeName, routingKey: _routingKey, arguments: queueBindingArgs);
            ...
            _channel.QueueDeclare(invalidMessageQueueName, exclusive: false, autoDelete: false, durable: true);
            _channel.QueueBind(queue: invalidMessageQueueName, InvalidMessageExchangeName, invalidRoutingKey);
        }
